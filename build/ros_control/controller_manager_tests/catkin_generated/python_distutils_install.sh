...
echo_and_run cd "/home/tyrell/Skripsi/src/ros_control/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    "/home/tyrell/Skripsi/src/ros_control/controller_manager_tests/setup.py" \
     \
    build --build-base "/home/tyrell/Skripsi/build/ros_control/controller_manager_tests" \
    install \
    --root="${DESTDIR-/}" \
