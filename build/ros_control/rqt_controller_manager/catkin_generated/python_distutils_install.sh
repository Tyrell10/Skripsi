...
echo_and_run cd "/home/tyrell/Skripsi/src/ros_control/rqt_controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/home/tyrell/Skripsi/src/ros_control/rqt_controller_manager/setup.py" \
     \
    build --build-base "/home/tyrell/Skripsi/build/ros_control/rqt_controller_manager" \
    install \
    --root="${DESTDIR-/}" \
