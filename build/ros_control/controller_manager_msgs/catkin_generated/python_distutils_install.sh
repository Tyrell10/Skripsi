...
echo_and_run cd "/home/tyrell/Skripsi/src/ros_control/controller_manager_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/home/tyrell/Skripsi/src/ros_control/controller_manager_msgs/setup.py" \
     \
    build --build-base "/home/tyrell/Skripsi/build/ros_control/controller_manager_msgs" \
    install \
    --root="${DESTDIR-/}" \
