...
echo_and_run cd "/home/tyrell/conveyorBelt_ws/src/gazebo_ros_pkgs/gazebo_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/tyrell/conveyorBelt_ws/src/gazebo_ros_pkgs/gazebo_ros/setup.py" \
     \
    build --build-base "/home/tyrell/conveyorBelt_ws/build/gazebo_ros_pkgs/gazebo_ros" \
    install \
    --root="${DESTDIR-/}" \
