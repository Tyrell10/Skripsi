...
(cl:defclass <box_cmd_vel> (roslisp-msg-protocol:ros-message)
  ((linear
    :reader linear
    :initarg :linear
...
(cl:defclass box_cmd_vel (<box_cmd_vel>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <box_cmd_vel>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'box_cmd_vel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name conveyorbelt_models-msg:<box_cmd_vel> is deprecated: use conveyorbelt_models-msg:box_cmd_vel instead.")))

(cl:ensure-generic-function 'linear-val :lambda-list '(m))
(cl:defmethod linear-val ((m <box_cmd_vel>))
...
(cl:defmethod angular-val ((m <box_cmd_vel>))
  ...
  (angular m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <box_cmd_vel>) ostream)
  "Serializes a message object of type '<box_cmd_vel>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <box_cmd_vel>) istream)
  "Deserializes a message object of type '<box_cmd_vel>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<box_cmd_vel>)))
  "Returns string type for a message object of type '<box_cmd_vel>"
  "conveyorbelt_models/box_cmd_vel")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'box_cmd_vel)))
  "Returns string type for a message object of type 'box_cmd_vel"
  "conveyorbelt_models/box_cmd_vel")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<box_cmd_vel>)))
  "Returns md5sum for a message object of type '<box_cmd_vel>"
  "9f195f881246fdfa2798d1d3eebca84a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'box_cmd_vel)))
  "Returns md5sum for a message object of type 'box_cmd_vel"
  "9f195f881246fdfa2798d1d3eebca84a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<box_cmd_vel>)))
  "Returns full string definition for message of type '<box_cmd_vel>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'box_cmd_vel)))
  "Returns full string definition for message of type 'box_cmd_vel"
  (cl:format cl:nil "geometry_msgs/Vector3 linear~%geometry_msgs/Vector3 angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <box_cmd_vel>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <box_cmd_vel>))
