...
class object_cmd_vel {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new object_cmd_vel(null);
  ...
  static datatype() {
    ...
    return 'conveyorbelt_models/object_cmd_vel';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new object_cmd_vel(null);
