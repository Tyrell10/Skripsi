...
// (in-package conveyorbelt_models.msg)
...
class convey2_cmd_vel {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new convey2_cmd_vel(null);
  ...
  static datatype() {
    ...
    return 'conveyorbelt_models/convey2_cmd_vel';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new convey2_cmd_vel(null);
...
module.exports = convey2_cmd_vel;
